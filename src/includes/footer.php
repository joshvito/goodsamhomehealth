    <div class="footer">   	
      <span id="page-title">js Error</span>
        <p class="copyright">Copyright &copy; <?php echo date(Y);?>  Good Samaritan Home Health Agency</p>
    	<span id="sitemap" class="copyright"><a href="/sitemap.php">Sitemap </a>&nbsp; | &nbsp;</span>
    </div>  
